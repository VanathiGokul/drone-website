...
export default function DroneScope() {
  ...
  const capabilities = [
    {
      ...
      image: droneScopeBg,
      imagePosition: 'object-cover object-[center_20%] sm:object-top',
    },
    {
      id: '02',
      title: 'FIRE FIGHTING',
      ...
      imagePosition: 'object-cover object-[center_35%] sm:object-center',
    },
    {
      id: '03',
      title: '3D MAPPING',
      ...
      imagePosition: 'object-cover object-[center_25%] sm:object-[center_30%]',
    }
  ];
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      rafId = requestAnimationFrame(() => {
        ...
        setActiveTab((prev) => {
          // Hysteresis buffering for smooth threshold switching
          if (prev === 0) {
            return clamped > 0.38 ? 1 : 0;
          } else if (prev === 1) {
            if (clamped < 0.28) return 0;
            if (clamped > 0.72) return 2;
            return 1;
          } else {
            return clamped < 0.62 ? 1 : 2;
          }
        });
      });
    };
  ...
  return (
    <section id="drone" ref={sectionRef} className="relative w-full h-auto lg:h-[300vh] border-t border-white/[0.04] scroll-mt-[76px] sm:scroll-mt-[88px] lg:scroll-mt-[100px]">
      ...
      <div className="relative lg:sticky top-0 w-full h-auto lg:h-screen flex flex-col justify-start lg:justify-between overflow-hidden bg-[#0A0A0B] pb-8 lg:pb-0">
        ...
        <div className="max-w-[1920px] w-full mx-auto px-5 sm:px-12 lg:px-[160px] relative z-10 text-center pt-8 lg:pt-[90px] mb-5 lg:mb-16 shrink-0">
          ...
          {/* Heading + Subtitle Frame (26:71) - 24px spacing */}
            ...
            {capabilities.map((cap, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Thin Stroke below scope heading (omitted for last item) */}
                  {!isLast && (
                    <div
