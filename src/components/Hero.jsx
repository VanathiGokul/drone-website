...
import heroPedestal from '../assets/hero_pedestal.png';
    ...
    <section className="relative w-full bg-[#121418] overflow-hidden flex flex-col justify-between">
      ...
      <div className="max-w-[1920px] w-full mx-auto relative z-10 px-6 sm:px-12 lg:px-[160px] flex flex-col justify-between flex-1">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-end mt-2">
          {/* 3D Pedestal Drone & AMR Image - Enlarged with bottom offset to eliminate gap when floating */}
          <div className="lg:col-span-8 relative flex justify-center lg:justify-start items-end self-end">
            <div className="relative w-full max-w-6xl xl:max-w-[1140px] group flex items-end animate-float -mb-6 lg:-mb-8 origin-bottom">
              <img
                src={heroPedestal}
                alt="Autonomous Drone and AMR on high-tech pedestals"
                className="w-full h-auto object-contain object-bottom drop-shadow-[0_20px_50px_rgba(0,0,0,0.9)] transition-transform duration-700 hover:scale-[1.02] block scale-[1.05] lg:scale-[1.08] origin-bottom"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col justify-start items-end self-start pt-4 sm:pt-6 lg:pt-8 xl:pt-10 xl:pl-4">
            <p className="font-space font-normal text-right text-[16px] sm:text-[18px] xl:text-[20px] leading-[26px] xl:leading-[28px] text-[#A9A9A9] max-w-[556px]">
              We build intelligent drones and autonomous mobile robots that secure, survey, and support your most critical operations, putting real-time intelligence in front of leadership 24/7
            </p>
          </div>
        </div>
      </div>
